...
public class MatriculaConstantes {  private static final LocalDate date = LocalDate.of(2004, 05, 31);
    ...
    public static final MatriculaDto MATRICULA_DTO_INVALIDA = new MatriculaDto(null, null);
    public static final MatriculaDto MATRICULA_DTO_VAZIA = new MatriculaDto();
}